...
\begin{definition}[Jaccard similarity index \citep{galbrun2018redescription}]
...
\Citep{zakimohammed2005} then developed a redescription mining algorithm utilizing the CHARM-L algorithm to find the exact conditional redescriptions from the lattice.